...
`,o+="¡Gracias!";const c=encodeURIComponent(o);window.open(`https://wa.me/51949799869?text=${c}`,"_blank"),v(),p()}w?.addEventListener("click",p);k?.addEventListener("click",v);S?.addEventListener("click",E);d?.addEventListener("click",t=>{t.target===d&&p()});window.openCart=y;window.updateQuantity=x;window.removeFromCart=C;
